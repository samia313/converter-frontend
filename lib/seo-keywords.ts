export const seoKeywords = {
  ...
  toolLinks: {
    ...
    'ocr-pdf': { title: 'OCR PDF', description: 'Extract searchable text from scanned PDF documents.', relatedTools: ['pdf-to-word','pdf-editor','compress-pdf'], keywords: ['OCR PDF','extract text from PDF','PDF text recognition'] },
