export const seoKeywords = {
  ...
  toolLinks: {
    ...
    'edit-pdf': { title: 'PDF Editor', description: 'Edit and annotate PDF documents online.', relatedTools: ['pdf-to-word','merge-pdf','protect-pdf'], keywords: ['PDF Editor','edit PDF online','modify PDF'] },
    'protect-pdf': { title: 'Protect PDF', description: 'Protect PDF files with available password and security options.', relatedTools: ['unlock-pdf','edit-pdf','compress-pdf'], keywords: ['Protect PDF','password protect PDF','secure PDF'] },
    'unlock-pdf': { title: 'Unlock PDF', description: 'Unlock PDFs when you have the required password or authorization.', relatedTools: ['protect-pdf','edit-pdf','merge-pdf'], keywords: ['Unlock PDF','remove PDF password','unlock PDF'] },
    ...
    'page-numbers': { title: 'Add Page Numbers to PDF', description: 'Add page numbers to PDF documents online.', relatedTools: ['merge-pdf','edit-pdf','rotate-pdf'], keywords: ['add page numbers to PDF','number PDF pages','PDF page numbering'] },
    'watermark-pdf': { title: 'Watermark PDF', description: 'Add watermarks to PDF documents online.', relatedTools: ['edit-pdf','protect-pdf','sign-pdf'], keywords: ['Watermark PDF','add watermark to PDF','PDF watermark'] },
    'redact-pdf': { title: 'Redact PDF', description: 'Redact sensitive information from PDF documents.', relatedTools: ['edit-pdf','protect-pdf','ocr'], keywords: ['Redact PDF','PDF redaction','remove sensitive information from PDF'] },
    'sign-pdf': { title: 'Sign PDF', description: 'Add signatures to PDF documents online.', relatedTools: ['edit-pdf','protect-pdf','watermark-pdf'], keywords: ['Sign PDF','sign PDF online','add signature to PDF'] },
    ...
    'pdf-to-excel': { title: 'PDF to Excel Converter', description: 'Convert PDF tables and documents to editable Excel spreadsheets online.', relatedTools: ['pdf-to-word','excel-to-pdf','ocr'], keywords: ['PDF to Excel','PDF to XLSX','convert PDF to Excel'] },
  ...
  linkChains: [
    ...
    ['merge-pdf','split-pdf','compress-pdf','edit-pdf','ocr'],
