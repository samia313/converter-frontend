export const seoKeywords = {
  ...
  toolLinks: {
    ...
    'redact-pdf': { title: 'Redact PDF', description: 'Redact sensitive information from PDF documents.', relatedTools: ['edit-pdf','protect-pdf','ocr-pdf'], keywords: ['Redact PDF','PDF redaction','remove sensitive information from PDF'] },
