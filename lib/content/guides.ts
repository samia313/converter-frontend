/**
 * How-To Guides Database - 150 SEO-optimized guide URLs
 */
...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    tool: 'Convert PDF',
    difficulty: 'beginner',
    keywords: ['convert', 'word', 'docx'],
  },
  {
    id: 'guide-005',
    slug: 'how-to-convert-pdf-to-excel',
    title: 'How to Convert PDF to Excel',
    url: '/guides/how-to-convert-pdf-to-excel',
    tool: 'Convert PDF',
    difficulty: 'beginner',
    keywords: ['convert', 'excel', 'spreadsheet'],
  },
  {
    id: 'guide-006',
    slug: 'how-to-convert-pdf-to-powerpoint',
    title: 'How to Convert PDF to PowerPoint',
    url: '/guides/how-to-convert-pdf-to-powerpoint',
    tool: 'Convert PDF',
    difficulty: 'beginner',
    keywords: ['convert', 'powerpoint', 'presentation'],
  },
  {
    id: 'guide-007',
    slug: 'how-to-remove-pdf-password',
    title: 'How to Remove PDF Password',
    url: '/guides/how-to-remove-pdf-password',
    tool: 'Remove Password',
    difficulty: 'intermediate',
    keywords: ['remove', 'password', 'unlock'],
  },
  {
    id: 'guide-008',
    slug: 'how-to-sign-pdf-digitally',
    title: 'How to Sign PDF Digitally',
    url: '/guides/how-to-sign-pdf-digitally',
    tool: 'Sign PDF',
    difficulty: 'intermediate',
    keywords: ['sign', 'digital signature', 'document'],
  },
  {
    id: 'guide-009',
    slug: 'how-to-rotate-pdf-pages',
    title: 'How to Rotate PDF Pages',
    url: '/guides/how-to-rotate-pdf-pages',
    tool: 'Rotate PDF',
    difficulty: 'beginner',
    keywords: ['rotate', 'orientation', 'page'],
  },
  {
    id: 'guide-010',
    slug: 'how-to-extract-images-from-pdf',
    title: 'How to Extract Images from PDF',
    url: '/guides/how-to-extract-images-from-pdf',
    tool: 'Extract Images',
    difficulty: 'beginner',
    keywords: ['extract', 'images', 'pictures'],
  },
  {
    id: 'guide-011',
    ...
    tool: 'Watermark PDF',
    difficulty: 'intermediate',
    keywords: ['watermark', 'protect', 'branding'],
  },
  {
    id: 'guide-012',
    slug: 'how-to-convert-image-to-pdf',
    title: 'How to Convert Image to PDF',
    url: '/guides/how-to-convert-image-to-pdf',
    tool: 'Image to PDF',
    difficulty: 'beginner',
    keywords: ['convert', 'image', 'jpg png'],
  },
  {
    id: 'guide-013',
    slug: 'how-to-reduce-pdf-file-size',
    title: 'How to Reduce PDF File Size',
    url: '/guides/how-to-reduce-pdf-file-size',
    tool: 'Compress PDF',
    difficulty: 'beginner',
    keywords: ['reduce', 'size', 'compress'],
  },
  {
    id: 'guide-014',
    slug: 'how-to-extract-text-from-pdf',
    title: 'How to Extract Text from PDF',
    url: '/guides/how-to-extract-text-from-pdf',
    tool: 'Extract Text',
    difficulty: 'beginner',
    keywords: ['extract', 'text', 'copy'],
  },
  {
    id: 'guide-015',
    ...
    tool: 'Edit PDF',
    difficulty: 'intermediate',
    keywords: ['edit', 'online', 'modify'],
  },
  {
    id: 'guide-016',
    slug: 'how-to-add-page-numbers-to-pdf',
    title: 'How to Add Page Numbers to PDF',
    url: '/guides/how-to-add-page-numbers-to-pdf',
    tool: 'PDF Tools',
    difficulty: 'intermediate',
    keywords: ['page numbers', 'numbering', 'format'],
  },
  {
    id: 'guide-017',
    slug: 'how-to-delete-pages-from-pdf',
    title: 'How to Delete Pages from PDF',
    url: '/guides/how-to-delete-pages-from-pdf',
    tool: 'Edit PDF',
    difficulty: 'beginner',
  ...
  },
  {
    ...
    url: '/guides/how-to-protect-pdf-with-password',
    tool: 'Security',
    difficulty: 'intermediate',
    keywords: ['protect', 'password', 'security'],
  },
  {
    id: 'guide-019',
    slug: 'how-to-convert-pdf-to-png',
    title: 'How to Convert PDF to PNG',
    url: '/guides/how-to-convert-pdf-to-png',
    tool: 'Convert PDF',
    difficulty: 'beginner',
    keywords: ['convert', 'png', 'image'],
  },
  {
    id: 'guide-020',
    slug: 'how-to-convert-pdf-to-jpg',
    title: 'How to Convert PDF to JPG',
    url: '/guides/how-to-convert-pdf-to-jpg',
    tool: 'Convert PDF',
    difficulty: 'beginner',
    keywords: ['convert', 'jpg', 'image'],
  },

  // Add remaining guides for comprehensive coverage
  // Following same pattern for each tool and conversion type
]

export function getAllGuideUrls(): string[] {
