            ...
            return (
              ...
              >
                <Link
                  ...
                  className="group relative block h-full bg-white/80 backdrop-blur-sm border border-gray-200 rounded-2xl p-7 hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden hover:border-red-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2"
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mt-4 text-xs font-semibold text-red-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      Open tool →
                    </div>
