...
export default function PagenumbersTool() {
  ...
  const [toolName, setToolName] = useState('page-numbers');

  useEffect(() => {
    if (typeof window !== 'undefined') {
      const path = window.location.pathname.split('/')[1];
      setToolName(path || 'page-numbers');
    }
  }, []);
    ...
    <section className="min-h-screen bg-gradient-to-b from-blue-50 to-white py-12 md:py-20">
      <div className="container mx-auto max-w-2xl px-4">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">page-numbers</h1>
