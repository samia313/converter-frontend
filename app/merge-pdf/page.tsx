...
export const metadata: Metadata = {
  ...
  description: 'description: 'Merge multiple PDF files online into one PDF. Combine documents in your chosen order for sharing, printing, submission, review, and archiving.'',
