...
Whatever documents you work with, this tool handles them all seamlessly.`}
      features={['Multi-format support','PDF and Word','Image support','Scanned files','Format auto-detection','Universal chat','One integrated tool','Complete compatibility']}
      benefits={['One tool all formats','Simplified workflow','No format conversion','Complete coverage','Easy integration','Time efficient','Cost effective','Unified solution']}
      useCase={['Mixed document types','Format diversity','Workflow simplification','Universal needs','Diverse collections','Format flexibility','Integrated workflows','Complete solutions','Multi-format projects','Unified chat'].join('\\n')}
      testimonials={[]}
      faqs={[{q:'What formats work?',a:'PDFs, Word documents, text files, images, scans - virtually any document format.'},{q:'Automatic detection?',a:'Yes, automatically detects and processes any document format.'}]}
      relatedTools={[{name:'AI Chat PDF',slug:'ai-chat-pdf'},{name:'AI Document Chat',slug:'ai-document-chat'}]}
