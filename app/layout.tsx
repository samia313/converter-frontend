...
const SITE_TITLE = 'Free PDF Tools Online – Merge, Compress, Convert & Edit PDFs | PDFilio'
const SITE_DESCRIPTION = 'Use free PDF tools online to merge, split, compress, convert, edit, OCR, sign, protect, and manage PDF files in your browser.'
...
export const metadata: Metadata = {
  ...
  keywords: ['free PDF tools online', 'PDF tools', 'PDF converter', 'merge PDF', 'compress PDF', 'split PDF', 'PDF editor', 'PDF to Word', 'Word to PDF', 'OCR PDF', 'PDF compressor'],
