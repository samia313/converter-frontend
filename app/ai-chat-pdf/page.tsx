...
export const metadata: Metadata = {
  ...
  keywords: ['AI chat PDF', 'chat with PDF', 'PDF AI chat', 'ask questions about PDF', 'talk to PDF', 'PDF question answering'],
...
AI responses depend on the document and the capabilities of the current product implementation. For contracts, legal documents, financial information, medical information, academic work, or other important decisions, always verify answers against the original PDF.`}
      features={[
      ...
      faqs={[
        ...
        { q: 'Can AI Chat PDF summarize a document?', a: 'You can ask questions that help you understand a document, while PDFilio also provides dedicated AI summarization workflows for document summaries.' },
      ...
      secondaryKeywords={['chat with pdf', 'PDF AI chat', 'ask questions about PDF', 'talk to PDF', 'PDF question answering']}
    />
  );
}
